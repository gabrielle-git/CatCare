  ...
  return (
    <div className="mx-auto w-full max-w-[820px] px-5 pb-8 pt-7 md:px-8 lg:py-10">
      ...
      <div className="mt-4 flex items-center gap-3">
        <span className="grid size-11 place-items-center rounded-[18px] bg-[var(--rose-soft)]">
          <ImagePlus size={20} />
        </span>
        <div>
          <p className="text-[10px] font-bold uppercase tracking-[0.14em] text-[var(--lavender-strong)]">Novo capítulo</p>
          <h1 className="text-3xl font-bold tracking-[-0.04em]">Guardar memória</h1>
        </div>
      </div>
      ...
      {configured && !editable && (
        <div className="mt-6 rounded-[20px] bg-[var(--peach)] px-4 py-3 text-sm">
          <Link href="/login" className="font-bold underline">Entre na conta</Link> para guardar a memória.
        </div>
      )}
      {flags.error && (
