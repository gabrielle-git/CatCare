  ...
  return (
    <form action={signup} className="mt-6 space-y-4">
      ...
      <label className="block text-sm font-semibold">Senha
        <input required minLength={8} type="password" name="password" autoComplete="new-password" className="focus-ring mt-2 w-full rounded-2xl border border-[var(--border)] bg-white px-4 py-3 font-normal" />
        <span className="mt-1.5 block text-xs font-normal text-[var(--muted)]">Pelo menos 8 caracteres.</span>
      </label>
